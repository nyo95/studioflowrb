# Ready for Review (ARCHIVED 2026-09-22)

> **Superseded.** Merged into [`docs/BACKLOG.md`](../BACKLOG.md) on 2026-09-22
> at owner request, consolidating this file with `roadmap.md` and
> `knownbug.md` into one worklist. Kept here as historical evidence of what
> was unverified through R8.105; do not add new items to this file.
