# Known Bugs by Application (ARCHIVED 2026-09-22)

> **Superseded.** Merged into [`docs/BACKLOG.md`](../BACKLOG.md) on 2026-09-22
> at owner request, consolidating this file with `roadmap.md` and `review.md`
> into one worklist. Kept here as historical evidence (including the full
> Closed ledger) of what was tracked through R8.105; do not add new items to
> this file.
