...
| `src/app/(platform)/studioflow/projects/_legacy_project_id/page.tsx` | custom component-level formatters with distinct options (same pattern as above); archived rebuild RB code, deactivated by SF-R1 (R8.71) |
| `src/app/(platform)/studioflow/projects/_legacy_project_id/files/page.tsx` | custom component-level formatter; archived rebuild RB code, deactivated by SF-R1 (R8.71) |
| `src/app/(platform)/studioflow/projects/_legacy_project_id/mom/[momId]/page.tsx` | `Intl.DateTimeFormat(undefined, ...)` intentionally formats in the viewer's locale without an app time zone; archived rebuild RB code, deactivated by SF-R1 (R8.71) |
