...
function workbook(): WorkbookData {
  return {
    ...
    sheets: Object.assign(Object.fromEntries(MASTERDATA_WORKBOOK_SHEETS.map((sheet) => [sheet, []])), {
      ...
      SkuPrice: [
        { id: "price-1", sku_id: "sku-1", supplier_party_id: null, amount: "0", currency: "IDR", unit_id: "unit-1", source_link_id: null, notes: null, updated_by_user_id: null, updated_by_label: "Owner", updated_at: "2026-08-27T00:00:00.000Z" },
        { id: "price-2", sku_id: "sku-1", supplier_party_id: "party-1", amount: "125000.50", currency: "IDR", unit_id: "unit-1", source_link_id: null, notes: "authorized supplier", updated_by_user_id: "user-1", updated_by_label: "Owner", updated_at: "2026-08-27T00:00:00.000Z" },
      ],
    }),
