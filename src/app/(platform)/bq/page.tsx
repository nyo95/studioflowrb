...
export default async function BqProjectsPage({
  ...
  return <>
    <PageHeader eyebrow="Bill of Quantity" title="Projects" description="Manage your BQ projects" actions={canManage ? <Link href="/bq/new" className={buttonClasses("primary", "md")}><Plus size={16} aria-hidden="true" /> New project</Link> : null} divider />
