...
- Compact-toolbar refinement: `41903e3` — symbol-only secondary utilities with accessible names/tooltips while filter value and selection count stay visible.
...
- The owner approved the refined warm-neutral, Programa-influenced visual direction. Master Data proceeds from `masterdata-full-build-start-ui-approved-v3`; both earlier UI-approved tags are superseded.
